...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register Complete') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('complete-register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="surnames" type="text" class="form-control @error('surnames') is-invalid @enderror" name="surnames" value="{{ old('surnames', auth()->user()->surnames) }}" required autocomplete="surnames" autofocus>
